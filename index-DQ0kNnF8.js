import { g as getDefaultExportFromCjs, U as requireReact, bp as requirePropTypes } from "./app-DBEXmgIl.js";
...
var getDeviceId_1;
var hasRequiredGetDeviceId;
function requireGetDeviceId() {
  if (hasRequiredGetDeviceId) return getDeviceId_1;
  hasRequiredGetDeviceId = 1;
  var _require = requireErrors(), NoVideoInputDevicesError = _require.NoVideoInputDevicesError;
  ...
  getDeviceId_1 = { getDeviceId, getFacingModePattern };
  return getDeviceId_1;
}
var havePropsChanged;
var hasRequiredHavePropsChanged;
function requireHavePropsChanged() {
  if (hasRequiredHavePropsChanged) return havePropsChanged;
  hasRequiredHavePropsChanged = 1;
  havePropsChanged = function havePropsChanged2(prevProps, nextProps, keys) {
    var changedProps = [];
...
var createBlob;
var hasRequiredCreateBlob;
function requireCreateBlob() {
  if (hasRequiredCreateBlob) return createBlob;
  hasRequiredCreateBlob = 1;
  createBlob = function createBlob2(parts, properties) {
    parts = parts || [];
...
const logging = log;
function shimGetUserMedia$3(window2) {
...
function shimPeerConnection$2(window2) {
  const browserDetails = detectBrowser(window2);
...
function requireSdp() {
  ...
  (function(module) {
    ...
    SDPUtils2.splitSections = function(blob) {
      ...
      return parts.map(function(part, index2) {
        return (index2 > 0 ? "m=" + part : part).trim() + "\r\n";
      });
    };
    ...
    SDPUtils2.getIceParameters = function(mediaSection, sessionpart) {
      ...
      lines = lines.concat(SDPUtils2.splitLines(sessionpart));
      var iceParameters = {
...
function requireRtcpeerconnection() {
  if (hasRequiredRtcpeerconnection) return rtcpeerconnection;
  hasRequiredRtcpeerconnection = 1;
  var SDPUtils2 = requireSdp();
  ...
  rtcpeerconnection = function(window2, edgeVersion) {
    ...
    RTCPeerConnection.prototype.createOffer = function() {
      ...
      var sdp2 = SDPUtils2.writeSessionBoilerplate(
        pc._sdpSessionId,
      ...
      pc.transceivers.forEach(function(transceiver, sdpMLineIndex) {
        ...
        if (transceiver.iceGatherer && pc.iceGatheringState !== "new" && (sdpMLineIndex === 0 || !pc.usingBundle)) {
          transceiver.iceGatherer.getLocalCandidates().forEach(function(cand) {
            cand.component = 1;
            sdp2 += "a=" + SDPUtils2.writeCandidate(cand) + "\r\n";
          });
...
var rtcpeerconnectionExports = requireRtcpeerconnection();
const shimRTCPeerConnection = /* @__PURE__ */ getDefaultExportFromCjs(rtcpeerconnectionExports);
...
function shimPeerConnection$1(window2) {
  const browserDetails = detectBrowser(window2);
...
function adapterFactory({ window: window2 } = {}, options = {
  ...
  switch (browserDetails.browser) {
    case "chrome":
      ...
      shimGetUserMedia$3(window2);
      shimMediaStream(window2);
      shimPeerConnection$2(window2);
...
var s=[e.top.endX-e.top.startX,e.bottom.endX-e.bottom.startX,e.bottom.y-e.top.y+1],a=t(s)/s.length;return{score:l({x:Math.round(r),y:Math.round(c)},[1,1,3,1,1],o),x:r,y:c,size:a}}}).filter(function(o){return!!o}).sort(function(o,e){return o.score-e.score}).map(function(o,e,r){if(e>B)return null;var t=r.filter(function(o,r){return e!==r}).map(function(e){return{x:e.x,y:e.y,score:e.score+Math.pow(e.size-o.size,2)/o.size,size:e.size}}).sort(function(o,e){return o.score-e.score});if(t.length<2)return null;var c=o.score+t[0].score+t[1].score;return{points:[o].concat(t.slice(0,2)),score:c}}).filter(function(o){return!!o}).sort(function(o,e){return o.score-e.score});if(0===i.length)return null;var m,f,w=c(i[0].points[0],i[0].points[1],i[0].points[2]),P=w.topRight,v=w.topLeft,h=w.bottomLeft;try{L=s(v,P,h,o),m=L.dimension,f=L.moduleSize}catch(o){return null}var p={x:P.x-v.x+h.x,y:P.y-v.y+h.y},y=(C(v,h)+C(v,P))/2/f,b=1-3/y,g={x:v.x+b*(p.x-v.x),y:v.y+b*(p.y-v.y)},x=a.map(function(e){var r=(e.top.startX+e.top.endX+e.bottom.startX+e.bottom.endX)/4,c=(e.top.y+e.bottom.y+1)/2;if(o.get(Math.floor(r),Math.floor(c))){var s=[e.top.endX-e.top.startX,e.bottom.endX-e.bottom.startX,e.bottom.y-e.top.y+1];t(s);return{x:r,y:c,score:l({x:Math.floor(r),y:Math.floor(c)},[1,1,1],o)+C({x:r,y:c},g)}}}).filter(function(o){return!!o}).sort(function(o,e){return o.score-e.score}),M=y>=15&&x.length?x[0]:g;return{alignmentPattern:{x:M.x,y:M.y},bottomLeft:{x:h.x,y:h.y},dimension:m,topLeft:{x:v.x,y:v.y},topRight:{x:P.x,y:P.y}};var L}Object.defineProperty(e,"__esModule",{value:!0});var B=4,k=.5,u=1.5,C=function(o,e){return Math.sqrt(Math.pow(e.x-o.x,2)+Math.pow(e.y-o.y,2))};e.locate=i}]).default}),self.addEventListener("message",function(o){var e=jsQR(o.data.data,o.data.width,o.data.height);e?postMessage(e.data):postMessage(null)});`], {
  ...
  lib = (_temp = _class = function(_Component) {
    ...
    _createClass(Reader, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        var changedProps = havePropsChanged2(this.props, nextProps, propsKeys);
      ...
      value: function render() {
        var _props4 = this.props, style = _props4.style, className = _props4.className, onImageLoad = _props4.onImageLoad, legacyMode = _props4.legacyMode, showViewFinder = _props4.showViewFinder;
        _props4.facingMode;
        var containerStyle = {
          overflow: "hidden",
          position: "relative",
...
//# sourceMappingURL=index-DQ0kNnF8.js.map
